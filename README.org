...
- Lists all packages installed via =package.el= with their *name*, *version*, *source*, *archive*, *maintainer*, *summary*, *URL*, and *install directory*
...
| Package     | Version | Source     | Archive | Maintainer    | Summary                      | URL                                   | Directory                          |
|-------------+---------+------------+---------+---------------+------------------------------+---------------------------------------+------------------------------------|
| magit       | 3.3.0   | configured | melpa   | Jonas Bernoulli | A Git porcelain inside Emacs | https://github.com/magit/magit       | ~/.emacs.d/elpa/magit-3.3.0/      |
| dash        | 2.19.1  | dependency | gnu     | Magnar Sveen  | A modern list library        | https://github.com/magnars/dash.el   | ~/.emacs.d/elpa/dash-2.19.1/      |
